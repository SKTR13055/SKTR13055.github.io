...
|----------|--------|------------------------|---------------------|---------------------|-----------|
| Success  | Syed Khalid Tipu Razvi  | Hands-On Lab| October 25, 2025    | October 26, 2025    | Blue Team |
...
**Result: Experiment failed on Virtual Machine. (***Unsuccessful.* Sysmon’s driver was blocked due to system protection features, preventing it from starting.)
...
![Windows Command Getting Logged in the Sysmon](/assets/images/%20Sysmon%20Detection%20Lab%20photos/Capture.png)

Mapping the Attack using the MITRE Framework

![Mapping the Attack using the MITRE Framework](/assets/images/%20Sysmon%20Detection%20Lab%20photos/Screenshot_2025-10-26_at_12.53.17_PM.png)

Mitigations For the Attack

![Mitigations For the Attack](/assets/images/%20Sysmon%20Detection%20Lab%20photos/Screenshot_2025-10-26_at_1.03.27_PM.png)

Execution Prevention Technique to mitigate the particular attack.

![Execution Prevention Technique to mitigate the particular attack.](/assets/images/%20Sysmon%20Detection%20Lab%20photos/Screenshot_2025-10-26_at_1.03.36_PM.png)
...
![Power Shell Command Getting Detected in the Sysmon Tool](/assets/images/%20Sysmon%20Detection%20Lab%20photos/PowerShell_Experiment.png)

![Screenshot 2025-10-27 at 12.31.56 PM.png](/assets/images/%20Sysmon%20Detection%20Lab%20photos/Screenshot_2025-10-27_at_12.31.56_PM.png)

![Screenshot 2025-10-27 at 12.32.17 PM.png](/assets/images/%20Sysmon%20Detection%20Lab%20photos/Screenshot_2025-10-27_at_12.32.17_PM.png)
