---
title: "PicoCTF – SSTI-1{Server-Side-Template-Injection}"
...
2. After Launching the instance, a page will be displayed with one input field.
    ...
    ![Screenshot 2025-12-08 at 8.30.09 PM.png](/assets/img/SSTI-1-Photos/Screenshot_2025-12-08_at_8.30.09_PM.png)

    ![Screenshot 2025-12-08 at 8.30.17 PM.png](/assets/img/SSTI-1-Photos/Screenshot_2025-12-08_at_8.30.17_PM.png)
...
- XSS
   ...
   ![Screenshot 2025-12-08 at 8.30.31 PM.png](/assets/img/SSTI-1-Photos/Screenshot_2025-12-08_at_8.30.31_PM.png)
...
5. Now there are several payloads to test out what type server is being used,To identify which template engine is being used by the application, we can inject specific payloads and observe the response. Below are some common template engines and their corresponding test payloads:
   ...
   ![Screenshot 2025-12-08 at 8.30.39 PM.png](/assets/img/SSTI-1-Photos/Screenshot_2025-12-08_at_8.30.39_PM.png)

6. By injecting the payload {{ "{{7*7}}" }}, the server evaluated the expression and returned 49, confirming the use of the Jinja2 template engine commonly found in Python Flask applications.
7. Now I found a payload which is able to execute shell commands which you can see down below.
   ...
   ![Screenshot 2025-12-08 at 8.31.11 PM.png](/assets/img/SSTI-1-Photos/Screenshot_2025-12-08_at_8.31.11_PM.png)
...
8. After giving the payload to the input field it announced as “root”, tinkering with the payload  to reveal the list of files in the current directory.
   ...
   ![Screenshot 2025-12-08 at 8.31.22 PM.png](/assets/img/SSTI-1-Photos/Screenshot_2025-12-08_at_8.31.22_PM.png)
...
9. After giving the adjusted payload I was able to see the flag file present in the current directory and to reveal the flag I just need to tinker with the payload one more time to reveal the flag which can be seen below.
   ...
   ![Screenshot 2025-12-08 at 8.32.14 PM.png](/assets/img/SSTI-1-Photos/Screenshot_2025-12-08_at_8.32.14_PM.png)
