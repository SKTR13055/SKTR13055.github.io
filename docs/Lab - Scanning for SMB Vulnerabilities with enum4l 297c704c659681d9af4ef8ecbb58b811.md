...
Experiment Start: November 6, 2025
Experiment End: November 6, 2025
Domain: Red Team
...
![Credit: Cisco.com](Lab%20-%20Scanning%20for%20SMB%20Vulnerabilities%20with%20enum4l/Screenshot_2025-11-06_at_12.26.41_PM.png)
...
This Lab is done for Educational Purposes and not to be performed for illegal activities.

</aside>

## Topology

![Credit: Cisco.com](Lab%20-%20Scanning%20for%20SMB%20Vulnerabilities%20with%20enum4l/Screenshot_2025-11-06_at_2.11.40_PM.png)
...
1. Before going to the step2 we have to understand these acronyms in order to make less confusing.
...
In order to identify the targets which are using SMB we need to examine the open ports, in the previous lab([Nmap](https://www.notion.so/Experiment-4-Using-Nmap-297c704c659681709277c6833bf97039?pvs=21) ) We learned how to use find and enumerate open ports on the target systems.
...
![Screenshot 2025-11-06 at 3.08.57 PM.png](Lab%20-%20Scanning%20for%20SMB%20Vulnerabilities%20with%20enum4l/Screenshot_2025-11-06_at_3.08.57_PM.png)

1. From the result I observed that the netbios-ssn(139/tcp) and microsoft-ds(445/tcp) were open which means the SMB severs are open and we can use the “enum4linux” tool.
2. While using “enum4linux” there are some options which we can use, but here are the most common options which are used
...
1. Type in the command “**enum4linux -U 172.17.0.2”** to find the configured users.

---

Starting enum4linux v0.9.1 ( [http://labs.portcullis.co.uk/application/enum4linux/](http://labs.portcullis.co.uk/application/enum4linux/) ) on Thu Nov  6 02:45:47 2025
...
1. Type in the command “**enum4linux -Sv 172.17.0.2”** 
...
1. in the Share files enumeration section I observed that there are 5 file shares are present and there are 3 hidden shares (denoted by $ at the end of the name.)
...
1. Type in the command “**enum4linux -P 172.17.0.2”** 

![Screenshot 2025-11-06 at 3.33.41 PM.png](Lab%20-%20Scanning%20for%20SMB%20Vulnerabilities%20with%20enum4l/Screenshot_2025-11-06_at_3.33.41_PM.png)
...
1. Now If you want to perform “All-in-one” option rather than typing certain single options you can do so by using the -a this option quickly performs multiple SMB operations in one scan.

![Screenshot 2025-11-06 at 4.25.53 PM.png](Lab%20-%20Scanning%20for%20SMB%20Vulnerabilities%20with%20enum4l/Screenshot_2025-11-06_at_4.25.53_PM.png)
...
![Screenshot 2025-11-06 at 4.35.15 PM.png](Lab%20-%20Scanning%20for%20SMB%20Vulnerabilities%20with%20enum4l/Screenshot_2025-11-06_at_4.35.15_PM.png)

1. I am going to use the -L command to get a list of shares available on a host(which is the target system) type in the command “**smbclient -L 172.17.0.2**” and press ENTER when asked for password. (The double / character before the IP address and the / following it are necessary if the target is a Windows computer, for example //172.17.0.2/)

![Screenshot 2025-11-06 at 4.38.18 PM.png](Lab%20-%20Scanning%20for%20SMB%20Vulnerabilities%20with%20enum4l/Screenshot_2025-11-06_at_4.38.18_PM.png)

1. From the result the “tmp” file share will be used in the experiment for demonstration purposes
...
1. Finally verify the file has been uploaded by typing in the “dir” command.

![Screenshot 2025-11-06 at 4.42.40 PM.png](Lab%20-%20Scanning%20for%20SMB%20Vulnerabilities%20with%20enum4l/Screenshot_2025-11-06_at_4.42.40_PM.png)

1. Type “quit” to exit from the prompt.
