...
This script helps locate a target by calculating the intersection of distances from three specific amenities (bars, restaurants, etc.) in a city. It pulls data directly from the **Overpass API** (OpenStreetMap).
